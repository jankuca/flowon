...
var EJS = function (options) {
	...
	if (options.precompiled) {
		this.template = {};
		var to_be_evaled = '/*' + this.name + '*/this.template.process = function (_CONTEXT,_VIEW) {	try { with(_VIEW) {	with (_CONTEXT) { ' + options.precompiled + " return ___ViewO.join('');}}}catch(e) { e.lineNumber=null;throw e;}};";
		eval(to_be_evaled);
